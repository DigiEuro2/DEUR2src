...
!define URL http://www.DigiEuro2.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/DigiEuro2.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\DigiEuro2-qt.exe
...
OutFile DigiEuro2-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/DigiEuro2-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/DigiEuro2d.exe
    ...
    #Delete /REBOOTOK $INSTDIR\DigiEuro2.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\DigiEuro2-qt.exe
