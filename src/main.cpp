...
int nCoinbaseMaturity = 10; //30 blocks
...
const string strMessageMagic = "DigiEuro2 Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy >>= ((pindexBest->nHeight - 1 + 2000) / 2000) * COIN;
    }
...
// DigiEuro2: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DigiEuro2", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "DigiEuro2 is a new cryptocurrency";
        CTransaction txNew;
        txNew.nTime = 1456328290;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xeb868e87806b630b4109fc07cc8a7e0e0b0f9e4d45c4787e3b1eb2a8f294916a"));
        block.print();
